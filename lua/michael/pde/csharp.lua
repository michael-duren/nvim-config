if not require("michael.core").pde.csharp then
	return {}
end
	...
	},
	{
		...
		opts = {
			servers = {
				...
				omnisharp = {
					cmd = vim.loop.os_uname().sysname == "Windows_NT" and {
						"C:\\ProgramData\\chocolatey\\bin\\OmniSharp.exe",
						"--languageserver",
						"--hostPID",
						tostring(vim.fn.getpid()),
					} or { "omnisharp", "--languageserver" },
