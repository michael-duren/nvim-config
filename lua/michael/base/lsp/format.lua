...
function M.toggle()
  ...
  vim.notify(M.autoformat and "Enbabled format on save" or "Disabled format on save")
end
...
function M.format()
  ...
  if M.format_notify then M.format_notify(formatters) end
  ...
  }, require("michael.base.lsp.utils").opts("nvim-lspconfig").format or {}))
end
